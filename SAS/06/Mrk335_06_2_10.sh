...
expression='#XMMEA_EP && (PATTERN<=4) && ((X,Y) IN circle(27770.5, 26940.5,1000)) &&(PI in [2000:10000])' \
...
energycolumn=PI \
expression='#XMMEA_EP && (PATTERN<=4) && ((X,Y) IN circle(27640.5,22580.5,1000))&&(PI in [2000:10000])' \
