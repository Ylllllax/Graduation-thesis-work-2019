...
expression='#XMMEA_EP && (PATTERN<=4) && ((X,Y) IN annulus(24160, 24750, 150, 1000)) &&(PI in [300:1000])' \
...
energycolumn=PI \
expression='#XMMEA_EP && (PATTERN<=4) && ((X,Y) IN circle(42440,30600,1500))&&(PI in [300:1000])' \
